...
export default function Question5() {
  return (
    ...
    >
      ...
      <p>
        The issue is the presence of restrictive caching headers (<code>no-store, no-cache</code>) on the origin response. This can be overriden through:
        <br />
        <ul>
          <li>
        ...
        Diagnosing involves inspecting response headers using tools like <code>curl -I</code> or browser devtools network panel.
        <br />
        <br />
      ...
      <ul>
        <li>
          <a
            href="https://developers.cloudflare.com/cache/concepts/cdn-cache-control/"
            target="_blank"
