...
export default function Question4() {
  return (
    ...
    >
      ...
      <ul>
        <li>
          <strong>Cloudflare Nameservers</strong> are authoritative — meaning they answer DNS queries based on the records you configure in Cloudflare.
        </li>
        <li>
          <strong>Google DNS / OpenDNS</strong> are public resolvers — they retrieve DNS info, but don&apos;t manage your DNS settings themselves.
        </li>
      </ul>
...
Proxy status: Proxied`}
      ...
      <ul>
        <li>
          <a
            href="https://developers.cloudflare.com/dns/concepts/"
            target="_blank"
