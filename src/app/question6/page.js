...
export default function Question6() {
  return (
    <main style={{
      ...
      <ul>
        <li><strong>Cloudflare Dashboard</strong> — to create and configure the redirect rule</li>
        <li><strong>curl -A</strong> — to test and simulate different user agents</li>
      </ul>

      <h2 style={{ color: '#404041' }}>References</h2>
      <ul>
        <li>
          <a href="https://developers.cloudflare.com/rules/" target="_blank" rel="noopener noreferrer" style={{ color: '#f48120' }}>
            Cloudflare Rules Overview
          </a>
        </li>
        <li>
          <a href="https://developers.cloudflare.com/rules/url-forwarding/" target="_blank" rel="noopener noreferrer" style={{ color: '#f48120' }}>
