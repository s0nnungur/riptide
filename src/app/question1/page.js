...
export default function Question1() {
  return (
    <main style={{
      ...
      <p><b>Tools used:</b> <code>nslookup</code> (Windows), <code>dig</code> (Linux), Cloudflare documentation</p>
...
example.com nameserver = b.iana-servers.net`}
      ...
      <p>
        The domain is <strong>NOT</strong> using Cloudflare nameservers.<br />
      </p>
<p>
